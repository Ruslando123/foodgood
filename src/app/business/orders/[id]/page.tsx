...
const LABELS: Record<string, string> = { RESERVED: "Забронирован · оплата при получении", READY_FOR_PICKUP: "Готов к выдаче", COMPLETED: "Выдан", CANCELLED: "Отменён", EXPIRED: "Истёк" };
