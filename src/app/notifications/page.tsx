...
export default async function NotificationsPage() {
  ...
  return <div className="mx-auto min-h-dvh max-w-md bg-white pb-20"><header className="sticky top-0 z-10 bg-white/95 px-4 pb-3 pt-5 backdrop-blur-xl"><h1 className="text-[24px] font-bold tracking-[-0.03em]">Уведомления</h1><p className="mt-1 text-[13px] text-muted">Всё важное о заказах и любимых местах</p></header><NotificationsFeed initialNotifications={items} /><BottomNav /></div>;
}
